...
export const SCREENS: VisualScreen[] = [
  ...
  {
    id: "student-tutor",
    prototype: "tutor.html",
    appPath: "/student/tutor",
    role: "student",
  },
  {
    id: "student-progress",
    prototype: "progress.html",
    appPath: "/student/progress",
    role: "student",
  },
  {
    id: "student-journal",
    prototype: "journal.html",
    appPath: "/student/journal",
    role: "student",
  },
  {
    id: "student-leaderboard",
    prototype: "leaderboard.html",
    appPath: "/student/leaderboard",
    role: "student",
  },
  {
    id: "student-marketplace",
    prototype: "marketplace.html",
    appPath: "/student/marketplace",
    role: "student",
  },
  {
    id: "student-portfolio",
    prototype: "portfolio.html",
    appPath: "/student/portfolio",
    role: "student",
  },
  {
    id: "student-courses",
    prototype: "learn.html",
    appPath: "/student/courses",
    role: "student",
  },
  ...
  { id: "student-assignment", prototype: "assignment.html", role: "student" },
  {
    id: "student-team",
    prototype: "team.html",
    appPath: "/student/team",
    role: "student",
  },
  {
    id: "student-calendar",
    prototype: "calendar.html",
    appPath: "/student/calendar",
    role: "student",
  },
  {
    id: "student-settings",
    prototype: "settings.html",
    appPath: "/student/settings/profile",
    role: "student",
  },
  {
    id: "student-profile",
    prototype: "profile.html",
    appPath: "/student/profile",
    role: "student",
  },
  ...
  { id: "student-quests", prototype: "quests.html", role: "student" },
  {
    ...
    prototype: "transcript.html",
    appPath: "/student/transcript",
    role: "student",
  },
  { id: "student-badges", prototype: "badges.html", role: "student" },
  {
    id: "student-learning-profile",
    prototype: "learning-profile.html",
    role: "student",
  },
  ...
  // ── Teacher ───────────────────────────────────────────────────────────────
  {
    ...
    prototype: "teacher-dashboard.html",
    appPath: "/teacher/dashboard",
    role: "teacher",
    rebuilt: true,
    maxDiffRatio: 0.6,
  },
  {
    id: "teacher-grading",
    prototype: "teacher-grading.html",
    appPath: "/teacher/grading",
    role: "teacher",
  },
  {
    id: "teacher-gradebook",
    prototype: "teacher-gradebook.html",
    appPath: "/teacher/gradebook",
    role: "teacher",
  },
  {
    id: "teacher-students",
    prototype: "teacher-students.html",
    role: "teacher",
  },
  {
    id: "teacher-curriculum",
    prototype: "teacher-curriculum.html",
    role: "teacher",
  },
  {
    id: "teacher-attendance",
    prototype: "teacher-attendance.html",
    appPath: "/teacher/attendance",
    role: "teacher",
  },
  {
    id: "teacher-rubrics",
    prototype: "teacher-rubrics.html",
    appPath: "/teacher/rubrics",
    role: "teacher",
  },
  {
    id: "teacher-questions",
    prototype: "teacher-questions.html",
    role: "teacher",
  },
  {
    id: "teacher-materials",
    prototype: "teacher-materials.html",
    role: "teacher",
  },
  {
    id: "teacher-handoffs",
    prototype: "teacher-handoffs.html",
    role: "teacher",
  },
  {
    id: "teacher-profile",
    prototype: "teacher-profile.html",
    appPath: "/teacher/settings/profile",
    role: "teacher",
  },
  ...
  {
    id: "parent-dashboard",
    prototype: "parent-dashboard.html",
    appPath: "/parent/dashboard",
    role: "parent",
    rebuilt: true,
    maxDiffRatio: 0.6,
  },
  {
    id: "parent-progress",
    prototype: "parent-progress.html",
    appPath: "/parent/progress",
    role: "parent",
  },
  {
    id: "parent-support",
    prototype: "parent-support.html",
    appPath: "/parent/planner",
    role: "parent",
  },
  {
    id: "parent-profile",
    prototype: "parent-profile.html",
    appPath: "/parent/profile",
    role: "parent",
  },
  ...
  // ── Coordinator ──────────────────────────────────────────────────────────
  {
    ...
    prototype: "coordinator-dashboard.html",
    appPath: "/coordinator/dashboard",
    role: "coordinator",
    rebuilt: true,
    maxDiffRatio: 0.6,
  },
  {
    ...
    prototype: "coordinator-outcomes.html",
    appPath: "/coordinator/plos",
    role: "coordinator",
  },
  {
    id: "coordinator-curriculum",
    prototype: "coordinator-curriculum.html",
    appPath: "/coordinator/matrix",
    role: "coordinator",
  },
  {
    id: "coordinator-accreditation",
    prototype: "coordinator-accreditation.html",
    appPath: "/coordinator/accreditation",
    role: "coordinator",
  },
  {
    id: "coordinator-cqi",
    prototype: "coordinator-cqi.html",
    role: "coordinator",
  },
  {
    id: "coordinator-competencies",
    prototype: "coordinator-competencies.html",
    role: "coordinator",
  },
  {
    id: "coordinator-course-file",
    prototype: "coordinator-course-file.html",
    role: "coordinator",
  },
  {
    id: "coordinator-teams",
    prototype: "coordinator-teams.html",
    role: "coordinator",
  },
  {
    id: "coordinator-profile",
    prototype: "coordinator-profile.html",
    appPath: "/coordinator/settings/profile",
    role: "coordinator",
  },
  ...
  {
    id: "admin-fees",
    prototype: "admin-fees.html",
    appPath: "/admin/fees",
    role: "admin",
  },
  {
    id: "admin-governance",
    prototype: "admin-governance.html",
    appPath: "/admin/governance",
    role: "admin",
  },
  {
    id: "admin-marketplace",
    prototype: "admin-marketplace.html",
    appPath: "/admin/marketplace",
    role: "admin",
  },
  {
    id: "admin-profile",
    prototype: "admin-profile.html",
    appPath: "/admin/settings/profile",
    role: "admin",
  },
  {
    id: "admin-security",
    prototype: "admin-security.html",
    appPath: "/admin/security",
    role: "admin",
  },
  ...
  {
    id: "admin-badges",
    prototype: "admin-badges.html",
    appPath: "/admin/badges",
    role: "admin",
  },
  ...
  //    chrome — the role prefix is intentionally "shared" not a specific role) ─
  {
    ...
    prototype: "announcements.html",
    role: "student",
  },
  {
    id: "shared-notifications",
    prototype: "notifications.html",
    appPath: "/student/notifications",
    role: "student",
  },
