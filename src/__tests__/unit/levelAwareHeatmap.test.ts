...
describe('computeLevelRelativeConsistencyScore', () => {
  ...
  it('returns 0 when all days are sabbatical', () => {
    ...
    expect(computeLevelRelativeConsistencyScore(days, history, sabbatical)).toBe(0);
  });
  ...
  it('returns 100 when all eligible days meet level requirement', () => {
    ...
    expect(computeLevelRelativeConsistencyScore(days, history, new Set())).toBe(100);
  });
  ...
  it('returns 50 when half the days meet level requirement', () => {
    ...
    expect(computeLevelRelativeConsistencyScore(days, history, new Set())).toBe(50);
  });
  ...
  it('excludes sabbatical dates from calculation', () => {
    ...
    expect(computeLevelRelativeConsistencyScore(days, history, sabbatical)).toBe(100);
  });

  it('returns 0 when no days have data', () => {
    expect(computeLevelRelativeConsistencyScore([], history, new Set())).toBe(0);
  });
});
