...
describe('directionManager', () => {
  ...
  describe('applyDirection', () => {
    ...
    it('sets Arabic font family for RTL languages', () => {
      applyDirection('ar');
      expect(document.documentElement.style.fontFamily).toContain('Noto Sans Arabic');
    });

    it('sets default font family for LTR languages', () => {
      applyDirection('en');
      expect(document.documentElement.style.fontFamily).toContain('Noto Sans');
      expect(document.documentElement.style.fontFamily).not.toContain('Noto Sans Arabic');
    });
