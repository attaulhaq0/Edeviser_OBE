...
describe('LevelProgressionChart', () => {
  ...
  it('renders step chart when data has multiple levels', () => {
    ...
    expect(screen.queryByTestId('level-progression-single')).not.toBeInTheDocument();
  });
  ...
  it('renders level-up markers at level increase points', () => {
    ...
    render(<LevelProgressionChart data={data} currentLevel={3} />);
    expect(screen.getByTestId('level-up-marker-2025-02-01')).toBeInTheDocument();
    expect(screen.getByTestId('level-up-marker-2025-03-01')).toBeInTheDocument();
  });
  ...
  it('does not render level-up markers for level decreases', () => {
    ...
    expect(screen.queryByTestId('level-up-marker-2025-02-01')).not.toBeInTheDocument();
    expect(screen.getByTestId('level-up-marker-2025-03-01')).toBeInTheDocument();
  });
