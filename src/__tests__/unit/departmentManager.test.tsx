...
vi.mock('@/hooks/useDepartments', () => ({
  useDepartments: vi.fn(() => ({
    data: [
      { id: 'd1', name: 'Computer Science', code: 'CS', head_of_department_id: 'u1', institution_id: 'inst-1', created_at: '2025-01-01' },
      { id: 'd2', name: 'Mathematics', code: 'MATH', head_of_department_id: null, institution_id: 'inst-1', created_at: '2025-01-01' },
    ],
    isLoading: false,
  })),
