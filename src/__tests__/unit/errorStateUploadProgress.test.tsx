...
import UploadProgress, { formatFileSize } from '@/components/shared/UploadProgress';
...
describe('ErrorState', () => {
  ...
  it('renders custom retry label', () => {
    render(<ErrorState message="Error" onRetry={() => {}} retryLabel="Retry Upload" />);
...
describe('RealtimeStatusBanner', () => {
  it('renders nothing when isLive is true', () => {
    const { container } = render(
      <RealtimeStatusBanner isLive={true} />,
    );
    expect(container.firstChild).toBeNull();
  });
