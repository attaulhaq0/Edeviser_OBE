...
describe('HeatmapTooltip', () => {
  ...
  it('renders academic habits with checkmarks', () => {
    ...
    expect(screen.getByTestId('tooltip-habit-login')).toHaveTextContent('Login');
    expect(screen.getByTestId('tooltip-habit-submit')).toHaveTextContent('Submit');
  });
  ...
  it('renders wellness habits in separate section', () => {
    ...
    expect(screen.getByTestId('tooltip-habit-meditation')).toHaveTextContent('Meditation');
    expect(screen.getByTestId('tooltip-habit-exercise')).toHaveTextContent('Exercise');
  });
  ...
  it('shows streak active status', () => {
    ...
    expect(screen.getByTestId('tooltip-streak')).toHaveTextContent('🔥 Streak active');
  });
  ...
  it('shows streak broken status', () => {
    ...
    expect(screen.getByTestId('tooltip-streak')).toHaveTextContent('Streak broken');
  });
