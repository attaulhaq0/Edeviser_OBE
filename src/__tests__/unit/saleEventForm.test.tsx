...
vi.mock('@/hooks/useMarketplaceAdmin', () => ({
  useAdminMarketplaceItems: () => ({
    data: [
      { id: '1', name: 'Ocean Blue Theme', xp_price: 500, category: 'cosmetic', is_active: true },
      { id: '2', name: 'XP Boost', xp_price: 300, category: 'power_up', is_active: true },
      { id: '3', name: 'Inactive Item', xp_price: 100, category: 'cosmetic', is_active: false },
    ],
  }),
}));
...
describe('SaleEventForm', () => {
  it('renders form title', () => {
    renderWithProviders();
    expect(screen.getByRole('heading', { name: 'Create Sale Event' })).toBeTruthy();
  });
  ...
  it('renders Create Sale Event submit button', () => {
    renderWithProviders();
    expect(screen.getByRole('button', { name: /Create Sale Event/i })).toBeTruthy();
  });
