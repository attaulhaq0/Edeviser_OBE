...
describe("AISuggestionCard", () => {
  const defaultProps = {
    id: "sug-1",
    suggestionText:
      "Before you tackle CLO-4 (Analyzing), strengthen your CLO-3 (Applying) skills.",
    weakCLOTitle: "CLO-3: Apply data structures",
    weakCLOAttainment: 55,
    socialProofText:
      "Students who improved CLO-3 before CLO-4 scored 34% higher.",
  ...
  it("displays CLO gap info with title and attainment percentage", () => {
    ...
    expect(
      screen.getByText("CLO-3: Apply data structures")
    ).toBeInTheDocument();
