...
describe('getAttainmentTextClass', () => {
  it('returns correct text classes for each level', () => {
    expect(getAttainmentTextClass(90)).toBe('text-green-600');
    expect(getAttainmentTextClass(75)).toBe('text-blue-600');
    expect(getAttainmentTextClass(55)).toBe('text-yellow-600');
    expect(getAttainmentTextClass(30)).toBe('text-red-600');
  });
});
