...
const mockEntries = [
  {
    ...
    course_id: "c1",
    content:
      "This is my first reflection entry about the course material and how I understood the key concepts presented in class.",
    clo_id: null,
    is_shared: false,
  ...
  },
  {
    ...
    course_id: "c2",
    content:
      "I shared this entry with my teacher to get feedback on my understanding of the learning outcomes.",
    clo_id: "clo-1",
    is_shared: true,
...
describe("JournalListPage", () => {
  ...
  it("navigates to entry editor on card click", async () => {
    ...
    const firstCard = screen
      .getByText(/This is my first reflection/)
      .closest('[role="button"]');
