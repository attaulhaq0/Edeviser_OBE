...
describe("EmailPreferencesSection", () => {
  ...
  it("renders switch toggles with correct aria labels", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByRole("switch", { name: /Toggle Streak Risk Alerts/i })
      ).toBeDefined();
      expect(
        screen.getByRole("switch", { name: /Toggle Weekly Summary/i })
      ).toBeDefined();
      expect(
        screen.getByRole("switch", { name: /Toggle New Assignments/i })
      ).toBeDefined();
      expect(
        screen.getByRole("switch", { name: /Toggle Grade Released/i })
      ).toBeDefined();
    });
  });
