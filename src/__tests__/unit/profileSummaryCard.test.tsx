...
vi.mock("recharts", async () => {
  ...
  return {
    ...
    RadarChart: ({
      ...
      React.createElement(
        "div",
        { "data-testid": "radar-chart", "data-points": data.length },
        children
      ),
    ...
    PolarGrid: () =>
      React.createElement("div", { "data-testid": "polar-grid" }),
...
describe("ProfileSummaryCard", () => {
  ...
  describe("VARK Self-Awareness section", () => {
    ...
    it("disclaimer mentions content adaptation exclusion", () => {
      renderCard();
      expect(screen.getByText(/not used for content adaptation/)).toBeDefined();
    });
