...
describe("likertResponseSchema", () => {
  it("accepts valid payload with option 1–5", () => {
    for (const opt of [1, 2, 3, 4, 5]) {
      const result = likertResponseSchema.safeParse({
...
describe("varkResponseSchema", () => {
  it("accepts valid payload with option 0–3", () => {
    for (const opt of [0, 1, 2, 3]) {
      const result = varkResponseSchema.safeParse({
        question_id: validUUID,
        selected_option: opt,
      });
      expect(result.success).toBe(true);
...
describe("baselineResponseSchema", () => {
  it("accepts valid payload with option 0–3", () => {
    for (const opt of [0, 1, 2, 3]) {
      const result = baselineResponseSchema.safeParse({
        question_id: validUUID,
        selected_option: opt,
      });
      expect(result.success).toBe(true);
...
describe("selfEfficacyResponseSchema", () => {
  it("accepts valid payload with option 1–5", () => {
    for (const opt of [1, 2, 3, 4, 5]) {
      const result = selfEfficacyResponseSchema.safeParse({
        question_id: validUUID,
        selected_option: opt,
      });
      expect(result.success).toBe(true);
  ...
  it("rejects missing fields", () => {
    ...
    expect(
      selfEfficacyResponseSchema.safeParse({ question_id: validUUID }).success
    ).toBe(false);
  });
});
...
describe("studyStrategyResponseSchema", () => {
  it("accepts valid payload with option 1–5", () => {
    for (const opt of [1, 2, 3, 4, 5]) {
      const result = studyStrategyResponseSchema.safeParse({
        question_id: validUUID,
        selected_option: opt,
      });
      expect(result.success).toBe(true);
...
describe("processOnboardingSchema", () => {
  ...
  it("rejects missing required fields", () => {
    ...
    expect(
      processOnboardingSchema.safeParse({ student_id: validUUID }).success
    ).toBe(false);
  });
});
...
describe("smartGoalTemplateSchema", () => {
  ...
  it("rejects missing required fields", () => {
    ...
    expect(
      smartGoalTemplateSchema.safeParse({
