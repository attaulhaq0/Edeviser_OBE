...
describe("Milestone Marker on HeatmapGrid", () => {
  ...
  it("renders star marker at milestone cell", () => {
    ...
    render(
      <HeatmapGrid data={days} semesterRange={range} milestones={milestones} />
    );

    expect(
      screen.getByTestId("milestone-marker-2025-01-10")
    ).toBeInTheDocument();
  });
  ...
  it("does not render marker on non-milestone cells", () => {
    ...
    expect(
      screen.queryByTestId("milestone-marker-2025-01-06")
    ).not.toBeInTheDocument();
    expect(
      screen.queryByTestId("milestone-marker-2025-01-09")
    ).not.toBeInTheDocument();
  });
  ...
  it("does not render markers when milestones prop is not provided", () => {
    ...
    expect(
      screen.queryByTestId("milestone-marker-2025-01-10")
    ).not.toBeInTheDocument();
  });
  ...
  it("renders multiple milestone markers", () => {
    ...
    expect(
      screen.getByTestId("milestone-marker-2025-01-08")
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("milestone-marker-2025-01-15")
    ).toBeInTheDocument();
  });
});
...
describe("HeatmapTooltip — Milestone label", () => {
  ...
  it("does not show milestone label when milestone is not provided", () => {
    ...
    expect(
      screen.queryByTestId("tooltip-milestone-label")
    ).not.toBeInTheDocument();
  });
});
