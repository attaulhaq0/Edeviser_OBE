...
describe("BLOOMS_VERBS", () => {
  ...
  it("contains the required verbs per requirement 38", () => {
    expect(BLOOMS_VERBS.remembering).toEqual([
      "define",
      "list",
      "recall",
      "identify",
    ...
    expect(BLOOMS_VERBS.understanding).toEqual([
      "explain",
      "describe",
      "classify",
      "summarize",
    ...
    expect(BLOOMS_VERBS.applying).toEqual([
      "use",
      "implement",
      "execute",
      "solve",
    ...
    expect(BLOOMS_VERBS.analyzing).toEqual([
      "compare",
      "differentiate",
      "examine",
      "break down",
    ...
    expect(BLOOMS_VERBS.evaluating).toEqual([
      "judge",
      "critique",
      "defend",
      "argue",
    ...
    expect(BLOOMS_VERBS.creating).toEqual([
      "design",
      "develop",
      "compose",
      "build",
