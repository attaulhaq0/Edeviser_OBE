  ...
  it("higher Blooms level yields equal or higher XP", () => {
    fc.assert(
      fc.property(
        ...
        fc.integer({ min: 1, max: 50 }),
        (baseXP, level) => {
          const xpRemembering = calculateFinalXP(
            baseXP,
            level,
            ["Remembering"],
            0,
          ...
          const xpCreating = calculateFinalXP(
            baseXP,
            level,
            ["Creating"],
            0,
    ...
    fc.assert(
      fc.property(
        ...
        (baseXP, level, repeatCount) => {
          const milestoneXP = calculateFinalXP(
            baseXP,
            level,
            [],
            repeatCount,
...
describe("Property 109: Diminishing returns mechanics", () => {
  it("diminishing multiplier decreases with repeat count", () => {
    fc.assert(
      fc.property(fc.integer({ min: 0, max: 9 }), (repeatCount) => {
  ...
  it("diminishing multiplier has a floor of 0.2", () => {
    fc.assert(
      fc.property(fc.integer({ min: 0, max: 100 }), (repeatCount) => {
    ...
    fc.assert(
      fc.property(
        ...
        (baseXP, level, repeatCount) => {
          ...
          const repeatedXP = calculateFinalXP(
            baseXP,
            level,
            [],
            repeatCount,
