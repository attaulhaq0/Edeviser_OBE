      ...
      fc.property(
        ...
        (parentLevel, childLevel) => {
          ...
          if (levelOrder[childLevel] > levelOrder[parentLevel]) {
            ...
            expect(levelOrder[childLevel]).toBeGreaterThan(levelOrder[parentLevel]);
          }
        },
      ),
      { numRuns: 100 },
    ...
    fc.assert(
      fc.property(
        ...
        (row) => {
          ...
          expect(items.map((i) => i.level)).toEqual(['domain', 'competency', 'indicator']);
    ...
    fc.assert(
      fc.property(
        ...
        (indicator) => {
          ...
          if (indicator.level === 'indicator' && indicator.mapping_count === 0) {
