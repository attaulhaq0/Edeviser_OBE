...
const challengeTypeArb = fc.constantFrom('academic', 'habit', 'xp_race', 'blooms_climb', 'cooperative') as fc.Arbitrary<'academic' | 'habit' | 'xp_race' | 'blooms_climb' | 'cooperative'>;

function makeValidChallenge(startOffset: number, durationDays: number, type: string) {
