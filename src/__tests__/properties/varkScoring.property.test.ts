...
const varkResponseSetArb: fc.Arbitrary<VARKResponseInput[]> = fc
  .array(fc.constantFrom(...MODALITIES), {
    minLength: TOTAL_QUESTIONS,
    maxLength: TOTAL_QUESTIONS,
  })
