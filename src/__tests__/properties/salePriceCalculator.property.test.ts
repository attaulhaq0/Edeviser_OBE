...
import { computeSalePrice, getHighestDiscount, type ActiveDiscount } from '@/lib/salePriceCalculator';
    ...
    fc.assert(
      fc.property(
        ...
        (basePrice, discounts) => {
          ...
          const expected = Math.max(1, basePrice - Math.floor((basePrice * maxDiscount) / 100));
