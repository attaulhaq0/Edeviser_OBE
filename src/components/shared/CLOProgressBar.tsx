...
const CLOProgressBar = ({
  ...
  const attainment = attainmentLevel
    ? ATTAINMENT_STYLES[attainmentLevel]
    : null;
  ...
  return (
    <div
      className={cn(
        "space-y-2",
        isClickable &&
          "cursor-pointer rounded-lg p-2 -m-2 transition-colors hover:bg-slate-50",
        className
      )}
      onClick={onClick}
