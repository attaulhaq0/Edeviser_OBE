...
// writes) and is composed from the P0 primitives (WelcomeHero, KPICard,
// SectionHeader, MasteryRing, `.card-elevated`). i18n reuses the existing
// `common` namespace `parentDashboard.*` keys. Flag-off keeps the current
// dashboard unchanged.
// =============================================================================
                    ...
                    <div className="flex min-w-0 items-center gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="truncate text-xs text-gray-500">
                          {t("parentDashboard.levelLabel")}{" "}
                          {child.current_level} · {child.enrolled_courses}{" "}
