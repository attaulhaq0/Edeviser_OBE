...
const TeamBadgeDisplay = ({
  teamId,
  compact = false,
}: TeamBadgeDisplayProps) => {
  ...
  if (isLoading) {
    return (
      <div
        className="animate-shimmer h-20 rounded-xl bg-gray-100"
        data-testid="team-badges-loading"
      />
    );
  }
  ...
  if (compact) {
    return (
      <div
        data-testid="team-badge-display-compact"
