  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-2 mt-1">
        <p className="text-2xl font-black">{currentValue.toLocaleString()}</p>
      ...
      {isPersonalBest && (
        <p
          ...
          data-testid="personal-best-label"
        >
          ⭐ Personal Best!
        </p>
      )}
