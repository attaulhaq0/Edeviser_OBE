...
const EmailPreferencesSection = () => {
  const { preferences, isLoading, isUpdating, updatePreferencesAsync } = useEmailPreferences();
    ...
    return (
      <Card className="bg-white border-0 shadow-md rounded-xl overflow-hidden">
        ...
        >
          ...
          <h2 className="text-lg font-bold tracking-tight text-white">Email Notifications</h2>
        </div>
