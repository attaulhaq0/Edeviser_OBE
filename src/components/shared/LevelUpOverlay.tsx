...
const LevelUpOverlay = ({ newLevel, onComplete }: LevelUpOverlayProps) => {
  ...
  const title =
    LEVEL_THRESHOLDS.find((t) => t.level === newLevel)?.title ?? "Unknown";
      ...
      {visible && (
        ...
        >
          ...
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={
              prefersReducedMotion ? { opacity: 0 } : { scale: 0.8, opacity: 0 }
            }
          ...
          >
            ...
            <motion.div
              ...
              initial={
                prefersReducedMotion ? undefined : { rotate: -180, scale: 0 }
              }
