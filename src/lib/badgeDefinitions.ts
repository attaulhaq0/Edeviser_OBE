...
export const BADGE_DEFINITIONS: BadgeDef[] = [
  ...
  // ── Onboarding badges ────────────────────────────────────────────────────
  {
    ...
    description:
      "Complete personality, learning style, and baseline assessments",
    icon: "🔬",
    category: "engagement",
    isMystery: false,
    condition:
      "Complete all three assessment sections (personality, learning style, and at least one baseline test)",
    xpReward: 50,
  },
  {
  ...
  // ── Study badges (Weekly Planner & Today View) ─────────────────────────────
  {
    ...
    category: "study",
    isMystery: false,
    condition: "Complete 1 study session in Focus Mode",
    xpReward: 25,
  },
  {
    id: "deep_focus",
    name: "Deep Focus",
    description: "Complete a 60-minute study session",
    icon: "🧘",
    category: "study",
    isMystery: false,
    condition: "Complete a single study session of 60 minutes or more",
    xpReward: 50,
  },
  {
    id: "weekly_warrior",
    name: "Weekly Warrior",
    description: "Meet all 3 weekly goals in a single week",
    icon: "🏆",
    category: "study",
    isMystery: false,
    condition: "Set and meet all 3 weekly goals in a single week",
    xpReward: 100,
  },
  {
    id: "evidence_pro",
    name: "Evidence Pro",
    description: "Attach evidence to 10 study sessions",
    icon: "📎",
    category: "study",
    isMystery: false,
    condition:
      "Upload evidence (files or notes) to 10 different study sessions",
    xpReward: 75,
  },
