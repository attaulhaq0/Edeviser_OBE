...
const QUESTION_TEMPLATES: QuestionTemplateMap = {
  "Concrete Experience": {
    remembering:
      'What specific facts or concepts from "{clo}" do you recall from this assessment?',
    understanding:
      'How would you describe your experience working on "{clo}" in your own words?',
    applying:
      'What was it like applying the concepts from "{clo}" to a concrete problem?',
    analyzing:
      'What patterns or connections did you notice while working on "{clo}"?',
    evaluating:
      'What was your experience evaluating or judging ideas related to "{clo}"?',
    creating:
      'What was the experience of creating something new for "{clo}" like for you?',
  },
  "Reflective Observation": {
    remembering:
      'Which parts of "{clo}" did you find easiest to recall, and where did you struggle?',
    understanding:
      'Looking back, which aspects of "{clo}" do you feel you understood well, and which were unclear?',
    applying:
      'Reflecting on your work, where did you apply concepts from "{clo}" effectively, and where did you struggle?',
    analyzing:
      'What assumptions did you make while analyzing "{clo}", and were they correct?',
    evaluating:
      'How confident were you in the judgments you made about "{clo}", and why?',
    creating:
      'What creative choices did you make for "{clo}", and what would you reconsider?',
  },
  "Abstract Conceptualization": {
    remembering:
      'What study strategies could help you better retain the key concepts of "{clo}"?',
    understanding:
      'What deeper principle or theory connects to your understanding of "{clo}"?',
    applying:
      'What general approach or framework could improve how you apply "{clo}" concepts next time?',
    analyzing:
      'What analytical framework or model could strengthen your work on "{clo}"?',
    evaluating:
      'What criteria or standards should guide your evaluation of "{clo}" topics in the future?',
    creating:
      'What design principles or creative methods could elevate your work on "{clo}"?',
  },
  "Active Experimentation": {
    remembering:
      'What specific steps will you take to reinforce your knowledge of "{clo}" before the next assessment?',
    understanding:
      'How will you deepen your understanding of "{clo}" — what will you try differently?',
    applying:
      'What real-world scenario could you practice applying "{clo}" concepts to?',
    analyzing:
      'How will you test your analytical skills on "{clo}" in a new context?',
    evaluating:
      'What will you do differently when evaluating "{clo}" topics in your next assignment?',
    creating:
      'What new project or approach will you experiment with to push your "{clo}" skills further?',
  },
};
...
export function generateJournalPrompt(
  ...
  const { cloTitle, bloomsLevel, attainmentLevel, rubricFeedbackSummary } =
    context;

  // Build intro text
  const introTemplate = INTRO_TEMPLATES[attainmentLevel];
  let promptText = interpolate(
    introTemplate,
    cloTitle,
    bloomsLevel,
    attainmentLevel
