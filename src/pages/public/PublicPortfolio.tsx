    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <Card className="bg-white border-0 shadow-md rounded-xl p-8 text-center max-w-md">
          ...
          <p className="text-sm text-gray-500 mt-2">This portfolio is either private or does not exist.</p>
        </Card>
      </div>
    );
  }
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        >
          <div className="p-6">
            ...
            <p className="text-sm text-white/70 mt-1">Student Learning Portfolio</p>
            <div className="flex gap-6 mt-4">
              <div>
                <p className="text-[10px] font-black tracking-widest uppercase text-white/50">Total XP</p>
                <p className="text-xl font-black text-amber-400">{data.totalXP.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-[10px] font-black tracking-widest uppercase text-white/50">Level</p>
        ...
        <Card className="bg-white border-0 shadow-md rounded-xl overflow-hidden">
          ...
          <div className="p-6">
            {data.clos.length === 0 ? (
              <p className="text-sm text-gray-400">No attainment data available.</p>
            ) : (
