    ...
    <div className="min-h-screen bg-slate-50 flex items-start justify-center p-6">
      <Card className="bg-white border-0 shadow-md rounded-xl max-w-3xl w-full">
        ...
        <CardContent className="prose prose-sm max-w-none text-gray-700 space-y-4">
          ...
          <p>
            By accessing or using the Edeviser platform, you agree to be bound
          ...
          <p>
            Edeviser is an outcome-based education management platform that
            provides tools for learning management, assessment, gamification,
          ...
          <p>
            ...
            users, or uploading malicious content.
          </p>
          ...
          <p>
            Content you create on the platform remains yours. Edeviser retains
            rights to the platform software, design, and branding.
          </p>
          ...
          <p>
            Edeviser is provided &quot;as is&quot; without warranties of any
          ...
          <p>
            ...
            <a
              href="mailto:legal@edeviser.com"
