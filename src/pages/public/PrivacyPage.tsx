    ...
    <div className="min-h-screen bg-slate-50 flex items-start justify-center p-6">
      <Card className="bg-white border-0 shadow-md rounded-xl max-w-3xl w-full">
        ...
        <CardContent className="prose prose-sm max-w-none text-gray-700 space-y-4">
          ...
          <p>
            We collect information you provide directly (name, email, institution) and usage data
            (page views, feature interactions) to improve the platform experience.
          </p>

          <h2 className="text-lg font-bold tracking-tight">2. How We Use Your Information</h2>
          <p>
            Your data is used to provide and improve the Edeviser platform, personalize your
            learning experience, generate analytics for educators, and support accreditation processes.
          </p>
          ...
          <p>
            ...
            are only enabled with your explicit consent via the cookie consent banner.
          </p>

          <h2 className="text-lg font-bold tracking-tight">4. Data Sharing</h2>
          <p>
            We do not sell your personal data. Data may be shared with your institution&apos;s
            administrators and educators as required for educational purposes.
          </p>

          <h2 className="text-lg font-bold tracking-tight">5. Data Retention</h2>
          <p>
            Your data is retained for the duration of your account. Upon account deletion,
            personal data is removed within 30 days. Anonymized analytics data may be retained.
          </p>
          ...
          <p>
            ...
            row-level security, and regular security audits.
          </p>

          <h2 className="text-lg font-bold tracking-tight">8. Contact</h2>
          <p>
            For privacy-related inquiries, contact us at{' '}
            <a href="mailto:privacy@edeviser.com" className="text-blue-600 underline">
