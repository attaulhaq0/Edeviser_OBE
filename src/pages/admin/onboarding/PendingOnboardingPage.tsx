...
const PendingOnboardingPage = () => {
  ...
  const reminderMutation = useStandardMutation({
    mutationFn: async ({
      studentId,
      email,
    }: {
  ...
  const handleSendReminder = (studentId: string, email: string) => {
    reminderMutation.mutate({ studentId, email });
  };
                ...
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        handleSendReminder(student.id, student.email)
                      }
                      className="text-xs"
                    >
