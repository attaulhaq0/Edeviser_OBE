...
import { LayoutDashboard, Users, BookOpen, GraduationCap, Target, ScrollText, Sparkles, FileText, UserCircle, Calendar, Building2, ClipboardList, Settings, Clock, CalendarDays, DollarSign, Award, Store } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/admin/badges/spotlight', icon: Award, label: 'Badge Spotlight' },
