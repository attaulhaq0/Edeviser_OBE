    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white border-0 shadow-md rounded-xl overflow-hidden">
        <div className="px-6 py-4 flex items-center gap-2" style={{ background: 'linear-gradient(93.65deg, #14B8A6 5.37%, #0382BD 78.89%)' }}>
          ...
          <h2 className="text-lg font-bold tracking-tight text-white">Evidence Analytics</h2>
        </div>
        <div className="p-6">
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <BarChart3 className="h-12 w-12 text-slate-300 mb-3" />
            <p className="text-sm text-slate-500">Historical evidence analytics will appear here once the materialized view is populated.</p>
            <Badge variant="outline" className="mt-2 text-xs">Requires mv_historical_evidence view</Badge>
          </div>
        </div>
      </Card>
    </div>
