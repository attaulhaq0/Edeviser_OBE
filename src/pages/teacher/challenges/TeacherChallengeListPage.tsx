...
import { useChallenges, useCancelChallenge, type SocialChallenge } from '@/hooks/useChallenges';
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white border-0 shadow-md rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          {!effectiveCourseId ? (
            <p className="text-sm text-gray-500 text-center py-6">Select a course to view challenges.</p>
          ) : isLoading ? (
            ...
            <p className="text-sm text-gray-500 text-center py-6">No challenges found.</p>
          ) : (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0 ms-4">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => navigate(`/teacher/challenges/${challenge.id}/edit`)}
