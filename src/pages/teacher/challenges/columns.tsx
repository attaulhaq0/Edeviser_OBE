  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="text-xs">
        {typeLabels[row.getValue<string>("challenge_type")] ??
          row.getValue("challenge_type")}
      </Badge>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <span className="text-sm text-gray-600">
        {metricLabels[row.getValue<string>("goal_metric")] ??
          row.getValue("goal_metric")}
      </span>
    ),
  },
  {
    ...
    header: "Target",
    cell: ({ row }) => (
      <span className="text-sm font-medium">{row.getValue("goal_target")}</span>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge
          variant="outline"
          className={statusStyles[status] ?? "bg-gray-100"}
        >
          {status}
        </Badge>
      );
