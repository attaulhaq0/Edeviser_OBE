...
const TeacherStudentsPage = () => {
  ...
  const grouped = useMemo(() => {
    ...
    for (const student of atRiskQuery.data ?? []) {
  ...
  const criticalCount = grouped.crit.length;
  const attentionCount = grouped.att.length;
  const monitorCount = grouped.mon.length;
