...
const QuestionBankPage = () => {
  ...
  const analyticsMap: Record<string, { quality_flag: 'good' | 'low_discrimination' | 'too_easy' | 'too_hard' | null }> = {};
  for (const row of analyticsRows ?? []) {
    analyticsMap[row.question_id] = { quality_flag: row.quality_flag as 'good' | 'low_discrimination' | 'too_easy' | 'too_hard' | null };
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <Select value={sourceFilter} onValueChange={(val) => setSourceFilter(val === 'all' ? '' : val)}>
          <SelectTrigger className="w-[160px] bg-white">
