...
const SemesterTrendView = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard icon={TrendingUp} title="Attainment Over Time">
        {trendsQuery.isLoading || outcomesQuery.isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mt-1.5 max-w-sm text-sm text-slate-500">
              This institution has no captured semester-level attainment history
              yet. New snapshots will appear here after the next capture.
            </p>
          </div>
        ) : (
          <>
            <p className="mb-4 text-sm text-slate-500">
              {pointCount} live snapshot points across {series.length} outcomes.
              A single point is shown as a baseline until another semester is
              captured.
            </p>
              ...
              <table className="w-full min-w-[640px] text-sm">
                <thead className="bg-slate-50 text-left text-xs uppercase tracking-wide text-slate-500">
                  <tr>
                    ...
                    <th className="px-4 py-3 font-semibold">Latest semester</th>
