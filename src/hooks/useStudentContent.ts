...
import type {
  CreateStudentContentInput,
  ReviewStudentContentInput,
...
export const useCreateStudentContent = () => {
  ...
  return useMutation({
    mutationFn: async (
      input: CreateStudentContentInput & { studentId: string }
    ) => {
      ...
      const { data, error } = await supabase
        ...
        .insert({
          ...
          content_data: contentData.content_data as unknown as Record<
            string,
            unknown
          >,
          status: "pending",
...
export const useReviewStudentContent = () => {
  ...
  return useMutation({
    mutationFn: async (
      input: ReviewStudentContentInput & { reviewerId: string }
    ) => {
