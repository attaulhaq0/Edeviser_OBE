...
CREATE INDEX idx_student_active_boosts_student ON student_active_boosts(student_id);
CREATE INDEX idx_student_active_boosts_expires ON student_active_boosts(student_id, expires_at DESC);
