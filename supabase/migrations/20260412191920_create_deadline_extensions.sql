...
CREATE INDEX idx_deadline_extensions_student ON deadline_extensions(student_id);
CREATE INDEX idx_deadline_extensions_assignment ON deadline_extensions(assignment_id);
