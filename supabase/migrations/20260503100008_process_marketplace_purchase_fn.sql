-- ============================================================
-- Migration 1.8: process_marketplace_purchase PL/pgSQL function
-- Feature: XP Marketplace & Virtual Economy
-- Atomic purchase processor with SECURITY INVOKER
-- (per CodeRabbit feedback — avoids privilege escalation)
-- ============================================================
...
BEGIN
  ...
  INSERT INTO xp_purchases (student_id, institution_id, item_id, xp_cost, status, purchased_at)
