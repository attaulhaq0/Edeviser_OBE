-- ============================================================
-- Migration 1.12: Seed default marketplace items
-- Feature: XP Marketplace & Virtual Economy
-- Template items with NULL institution_id (applied per institution)
-- ============================================================

-- Recreate the seed function with updated item catalog
...
BEGIN
  ...
  INSERT INTO marketplace_items (institution_id, name, description, category, sub_category, xp_price, level_requirement, stock_type, icon_identifier, metadata)
  VALUES
