...
DROP POLICY IF EXISTS "admin_manage_spotlight" ON badge_spotlight_schedule;`nCREATE POLICY "admin_manage_spotlight" ON badge_spotlight_schedule
  FOR ALL TO authenticated
  USING (true);

-- All roles can read spotlight
DROP POLICY IF EXISTS "all_read_spotlight" ON badge_spotlight_schedule;`nCREATE POLICY "all_read_spotlight" ON badge_spotlight_schedule
