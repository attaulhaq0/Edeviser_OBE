...
```ts
export const SEED_EMAIL_DOMAINS = ["demo.com", "noor-international.edu"] as const;
...
export function isSeedAccount(email?: string | null, institutionId?: string | null): boolean
```
